        ...
        <div className="flex flex-col space-y-6">
          ...
          <div className="bg-muted/30 p-4 rounded-lg border hover:bg-muted/50 transition-colors">
            <div className="flex items-center gap-4">
              <Link href={`/user/${product.seller.username}`}>
                <Avatar className="h-12 w-12 border-2 border-background cursor-pointer hover:opacity-90">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2">
                  <Link
                    href={`/user/${product.seller.username}`}
