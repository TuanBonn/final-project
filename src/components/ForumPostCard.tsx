    ...
    <Card className="hover:shadow-md transition-shadow border-l-4 border-l-primary/20">
      <CardHeader className="pb-3 pt-4 px-4 flex flex-row items-start gap-3 space-y-0">
        <Link href={`/user/${post.author.username}`}>
          <Avatar className="h-10 w-10 cursor-pointer border hover:opacity-80 transition-opacity">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 mb-1">
            <Link
              ...
              className="font-semibold text-sm truncate hover:underline hover:text-primary"
            >
